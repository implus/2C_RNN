...
local function gao()
    ...
    local check_point = torch.load('./models/implus_round11_epoch1.00_74.39.test95.026.model.t7')
    ...
    for round = 11, 10000 do -- 0 is first init mapx, mapy to run
        print("------------------------------- round "..round.." begin!! ---------------------------------")
        if round == 11 then
            params.decay = 1.5
            params.max_epoch     = 1
            params.max_max_epoch = 3
        else 
